package br.com.alurafood.pedidos.pedidos.controller;

import br.com.alurafood.pedidos.pedidos.dto.PedidoDto;
import br.com.alurafood.pedidos.pedidos.dto.StatusDto;
import br.com.alurafood.pedidos.pedidos.service.PedidoService;
...
public class PedidoController {
        ...
        public String returnPort(@Value("${local.server.port}") String port) {
            return String.format("Requisição executando na porta %s", port);
        }
